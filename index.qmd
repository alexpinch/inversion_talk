...
-   When the offspring is heterozygous for an inversion, recombination does not occur as a broken segment cannot find their homologous pair

## Why are inversions important?

-   15-20 years ago, found that inversions are way more prevalent than previously thought, on the order of 1000s (Kirkpatrick, 2010)
-   They can persist through populations and homozygotes can accumulate more deleterious mutations over time (Huang, 2022)
-   Still puzzling how they persist in populations over time
-   If genetic information is almost identical, how do they spread?
...
-   Which means that they might be locally adaptive
-   If an inversion traps alleles that become ecologically favoured, this could explain why they persist

::: notes
INVERSIONS: Why are they important? An individual could have (trapped in their inversion) alleles/genes that have been selected out over time, but have just recently become ecologically favourable
:::
...
::: notes
Roughly how inversions accumulate, and the current thinking for how
:::
...
-   SLiM uses a basic framework for modelling individuals over generations
-   Computes at the gene level, not concerned with base pairs
-   Uses a proprietary programming language built to be like R, but as fast as C
...
-   Preventing recombination is at the base of how inversions are physically maintained on the chromosome over time
-   So how we code recombination is integral to the model
...
-   Mutational load increases like found in Berdan et al. (2021)
-   What this means ![Fig. 2A-B, Berdan 2021 (Adapted)](berdan_2021.png)
